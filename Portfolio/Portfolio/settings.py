...
Generated by 'django-admin startproject' using Django 4.2.30 — upgraded to 6.0.8 since, see requirements.txt.
...
# Flat "name <email>" strings, not (name, email) tuples — the tuple form is deprecated
# as of Django 6.0 and slated for removal in 7.0.
_admin_email = os.environ.get('DJANGO_ADMIN_EMAIL')
ADMINS = [formataddr(('Cory Comly', _admin_email))] if _admin_email else []
